...
const CommentsModal = ({ post_pk, isModalOpen, setIsModalOpen }: commentData) => {
  ...
  return (
    <section className=" relative">
      ...
      >
        <h2 className="p-3 text-[1.2rem] font-semibold text-accent-purple">Make you comment</h2>
        ...
        <form className="p-4 border-border-grey border-1 rounded-3xl flex flex-col " onSubmit={commentPost}>
          <textarea onChange={(e) => setPostText(e.target.value)} style={{ resize: "none" }} className=" border-border-grey" rows={2} cols={53} name="createPost" id="createPost" placeholder="Make a comment"></textarea>
